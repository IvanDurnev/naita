...
YA_GPT_V2T = '''Посмотри текст, если в нем есть обращение к кому-либо на "вы", то замени его на обращение на "ты" во всех случаях и формах. Если обращений нет, то ничего менять не нужно. Верни исправленный текст.'''
